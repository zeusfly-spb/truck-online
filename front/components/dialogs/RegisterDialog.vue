...
const {authDialog, registerDialog, dialogMode, dialogTitle, dialog} = storeToRefs(authStore)
const {phoneConfirmed, emailConfirmed, companyConfirmed} = storeToRefs(configStore);
