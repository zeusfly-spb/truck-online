    ...
    <v-window v-model="tab" class="pt-6">
      ...
      <v-window-item value="cars">
        ...
        <v-row no-gutters>
          <v-col md :cols="12" class="mr-3 mb-3">
            <v-select
              label="Право использование"
              v-model="data.cars.rightOfUse.value"
              :items="data.cars.rightOfUse.list"
              class="text-body-1"
              variant="outlined"
              hide-details="auto"
            ></v-select>
          ...
          <v-col md :cols="12" class="mb-3">
            <v-text-field
              v-model="data.cars.loadСapacity"
        ...
        <v-row no-gutters>
          <v-col class="mb-3">
            <v-file-input
              label="Скан СТС на тягач и полуприцеп"
              v-model="data.cars.sts.file"
              class="text-body-1"
              variant="outlined"
              hide-details="auto"
            ></v-file-input>
      ...
      <v-window-item value="menegers">
        <v-row no-gutters class="align-center">
          <v-col md :cols="12" class="mr-3 mb-3">
            <v-autocomplete
              v-model="data.manager.fullName.value"
              :items="data.manager.fullName.list"
              auto-select-first
              density="comfortable"
              theme="light"
              item-props
