<template>
    <v-container class="mb-2">
      <v-form ref="order-create" @submit.prevent="submit" id="order-form">
        <v-row>
          ...
          <v-col cols="12" md="4">
            <v-select
              ...
              :items="addresses ? addresses.data.filter((address) => address.from == true) : []"
              item-value="id"
              item-title="name"
          ...
          <v-col cols="12" md="4">
            <v-text-field type="date" name="from_date" :rules="[rules.required]"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field type="time" name="from_slot" :rules="[rules.required]"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field
          ...
          <v-col cols="12" md="4">
            <v-select
              ...
              :items="addresses ? addresses.data.filter((address) => address.to == true) : []"
              item-value="id"
              item-title="name"
          ...
          <v-col cols="12" md="4">
            <v-text-field type="date" name="delivery_date" :rules="[rules.required]"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field type="time" name="delivery_slot" :rules="[rules.required]"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field
          ...
          <v-col cols="12" md="4">
            <v-select
              ...
              :items="addresses ? addresses.data.filter((address) => address.return == true) : []"
              item-value="id"
              item-title="name"
          ...
          <v-col cols="12" md="4">
            <v-text-field type="date" name="return_date" :rules="[rules.required]"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field type="time" name="return_slot" :rules="[rules.required]"></v-text-field>
          </v-col>
          <v-col cols="12" md="4">
            <v-text-field
        ...
        <v-row>
          <v-col cols="12" md="6">
            <v-card class="text-right text-h6 p-20" id="sum" text="0 руб" variant="outlined"></v-card>
          </v-col>
          <v-col cols="12" md="2">
            <v-btn
              :loading="loading"
...
const calculate = async () => {
  ...
  var sum = overWeightSum + defaultCarPrice + (distance*orderSetting.value.default_over_weight_price); // fullSum
...
const getContainerWeight = () => {
  ...
  var container = containers.value.data.filter((container) => container.id == containerId);
